...
if ($imagen_type=="image/gif" OR $imagen_type=="image/gif"){
 ...
 if($imagen_size>$lim_tamano){echo '<h2>La imagen excede el tama�o no debe pasar de 2 MB</h2>';
 }
...
#  la lectura al tama�o de fichero		
...
$bd = mysql_select_db ("imagen");
 $ci = $_SESSION["ci"];
 $tiempo = date("Y/m/d");
$query_log = "INSERT INTO log VALUES ('','$ci','Insertar enlaces','se inserto nueva imagen".$nombre." ".$descripcion."','$tiempo')";
